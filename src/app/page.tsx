...
export default function Home() {
  ...
  return <div className="min-h-screen text-neutral-900 dark:text-neutral-100"><Header /><div className="relative mx-auto grid grid-cols-1 md:grid-cols-[40%_auto] gap-15">
    <div className={`sticky top-10 h-fit ${composer.previewOpen ? "hidden md:block" : "block"}`}>
      <CompanyForm />
