...
import { schema } from "@/lib/schemas/companyForm"
...
export function useEmailComposer() {
  ...
  return {
    ...
    closingBlock,
    canSubmit,
    toggleAttachment: (key: AttachmentKey) => dispatch(toggleAttachment(key)),
    handleSubmit,
    resetForm: () => dispatch(resetForm()),
    showPreview: () => dispatch(setPreviewOpen(true)),
    closePreview: () => dispatch(setPreviewOpen(false)),
  }
}
